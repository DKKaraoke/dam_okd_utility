            ...
            if isinstance(message, OkdMidiGenericMessage):
                ...
                if status_type == 0x80:
                    ...
                    absolute_track.append(
                        (
                            absolute_time,
                            OkdMidiGenericMessage(0, bytes(note_on_bytearray), 0),
                        )
                    )
                    ...
                    absolute_track.append(
                        (
                            absolute_time + message.duration,
                            OkdMidiGenericMessage(0, bytes(note_off_bytearray), 0),
                        )
                    )
                    continue
                ...
                if status_type == 0x90:
                    ...
                    absolute_track.append(
                        (
                            absolute_time,
                            OkdMidiGenericMessage(0, bytes(message.data), 0),
                        )
                    )
